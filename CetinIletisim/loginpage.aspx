<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginpage.aspx.cs" Inherits="CetinIletisim.loginpage" %>
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-8">
                            <div class="alert alert-success hidden mt-lg" id="contactSuccess">
                                <strong>Başarılı Giriş Yaptınız!</strong>
                            </div>

                            <div class="alert alert-danger hidden mt-lg" id="contactError">
                                <strong>Hatalı Giriş Yaptınız!</strong> Kullanıcı adınızı veya parolanızı kontrol ediniz.
								<span class="font-size-xs mt-sm display-block" id="mailErrorMessage"></span>
                            </div>

                            <h2 class="mb-sm mt-sm"><strong>Giriş Yap</strong></h2>
                            ...
                            <div class="row">
                                <div class="col-md-6" align="right">
                                    <asp:Button ID="loginBtn" class="btn btn-primary btn-lg mb-xlg" runat="server" Text="Giriş Yap" OnClick="loginBtn_Click" />
